...
def post_telegraph(bot: Bot, update: Update, args: List[str]):
    short_name = "Created By @Gillz_13 😬"
    msg = update.effective_message # type: Optional[Message]
    telegraph = Telegraph()
...
__help__ = """
○ My Name : *Filter Bot*
○ Creator : [GILLZ_13](http://telegram.dog/GILLZ_13)
○ Credits : `Everyone in this journey`
○ Language : Python3
○ Library : [Leech_botz](https://t.me/joinchat/SyRE_E-X0awt7OVfFwSsUw)
○ Source Code : 👉 [Click Here](https://t.me/Filmyflx)
○ Server : Heroku
○ Build Status : V4 `[+0.4]`
"""
